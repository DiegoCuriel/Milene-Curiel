    ...
    <div id="contact" className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full ">
        ...
        <div className="flex flex-col items-end mt-12 py-12 px-4 max-w-2xl mx-auto">
          <div className="text-right w-full">
            <p className="text-lg mb-2 text-justify italic">
              &quot;Milene is a great team player. She&apos;s a go-getter and
              has always the best disposition to keep learning and keep the set
        ...
        <div className="flex flex-col items-end px-4 max-w-2xl mx-auto">
          <div className="text-right w-full">
            <p className="text-lg mb-2 text-justify italic">
              ...
              camera, I&apos;m really excited to see what&apos;s comming for her
              in the future.&quot;
            </p>
        ...
        <div className="flex flex-col items-end mt-12 px-4 max-w-2xl mx-auto">
          <div className="text-right w-full">
            <p className="text-lg mb-2 text-justify italic">
              &quot;Milene succesfully captured the behind-the-scenes process at
              our corporate events, accurately conveying the essence of each
              moment.&quot;
            </p>
